...
line_chart_weekday = draw_line(
    weekdays_int, close[1:idx_week], '收盘价星期均值（¥）', '星期均值') #星期显示的是数字
line_chart_weekday.x_labels = ['周一', '周二', '周三', '周四', '周五', '周六', '周日']
line_chart_weekday.render_to_file('/Users/wuxuhao/Desktop/Python/Data Json/files/收盘价星期均值（¥）.svg') #星期显示的是文字
line_chart_weekday

#用网页打开所有的svg图片
with open('/Users/wuxuhao/Desktop/Python/Data Json/files/收盘价Dashboard.html', 'w', encoding='utf8') as html_file:
    html_file.write(
        '<html><head><title>收盘价Dashboard</title><meta charset="utf-8"></head><body>\n')
    for svg in [
            '/Users/wuxuhao/Desktop/Python/Data Json/files/收盘价折线图（¥）.svg', 
            '/Users/wuxuhao/Desktop/Python/Data Json/files/收盘价对数变换折线图（¥）.svg', 
            '/Users/wuxuhao/Desktop/Python/Data Json/files/收盘价月日均值（¥）.svg',
            '/Users/wuxuhao/Desktop/Python/Data Json/files/收盘价周日均值（¥）.svg', 
            '/Users/wuxuhao/Desktop/Python/Data Json/files/收盘价星期均值（¥）.svg'
    ]:
        html_file.write(
